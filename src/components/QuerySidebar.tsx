...
const QuerySidebar = ({ onQuerySelect }: QuerySidebarProps) => {
  const sampleQueries = [
    ...
    },
    {
      ...
      queries: [
        ...
        "Streetlight repair complaints over time" // replaced to fit available categories
      ]
    },
    {
  ...
  return (
    <div className="w-80 municipal-sidebar p-6 overflow-y-auto bg-background h-full">
      {/* Search Section */}
      <div className="mb-8">
